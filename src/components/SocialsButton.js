  ...
  const SOCIALS = [
    {
      ...
      socialColor: '#1877F2',
      path: links.facebook || 'https://www.facebook.com/YulugMuhendislik/',
    },
    {
      name: 'Instagram',
      icon: 'ant-design:instagram-filled',
      socialColor: '#E02D69',
      path: links.instagram || 'https://www.instagram.com/smartmoles/?hl=tr',
    },
    {
      name: 'Linkedin',
      icon: 'eva:linkedin-fill',
      socialColor: '#007EBB',
      path: links.linkedin || 'https://tr.linkedin.com/company/smartmole-s?trk',
    },
    {
      name: 'Twitter',
      icon: 'eva:twitter-fill',
      socialColor: '#00AAEC',
      path: links.twitter || 'https://twitter.com/omeryulug',
    },
  ];
