...
export default function ContactMap() {
  ...
  const [viewport, setViewport] = useState({
    latitude: 38.46340720036928,
    longitude: 27.198459355824106,
    zoom: 12,
  });
      ...
      >
        ...
        {tooltip && (
          <MapControlPopup
            ...
            sx={{
              '& .mapboxgl-popup-content': { bgcolor: `${isLight ? '#FFF' : 'dark'}` },
              '&.mapboxgl-popup-anchor-bottom .mapboxgl-popup-tip': { borderTopColor: `${isLight ? '#FFF' : 'dark'}` },
              '&.mapboxgl-popup-anchor-top .mapboxgl-popup-tip': { borderBottomColor: `${isLight ? '#FFF' : 'dark'}` },
            }}
          >
